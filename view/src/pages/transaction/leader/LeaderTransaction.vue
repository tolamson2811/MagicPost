...
export default {
    ...
    computed: {
        ...
        createAccountLink() {
            return "/transaction/leader/" + this.leader_id + "/account/create";
        },
        listAccountLink() {
            return "/transaction/leader/" + this.leader_id + "/account/list";
        },
        statisticSentLink() {
            return "/transaction/leader/" + this.leader_id + "/statistic/sent";
        },
        statisticReceivedLink() {
            return (
                "/transaction/leader/" + this.leader_id + "/statistic/received"
            );
        },
    },
    mounted() {
