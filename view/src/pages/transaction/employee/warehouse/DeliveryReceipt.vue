<template>
    <main id="delivery-receipt" class="flex flex-col gap-8 pt-4">
        <!-- banner  -->
        <div class="flex items-center justify-between px-12">
            ...
            <qrcode-vue :value="linkQrCode" class="self-center"></qrcode-vue>
        </div>

        <!-- Phần thông tin  -->
        <div class="grid w-full grid-cols-2 px-2">
            <div class="flex flex-col gap-1 border-2 border-black px-2 pb-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <span class="flex items-center gap-1">
                        <p>Số điện thoại: {{ package_detail.sender_phone }}</p>
                    </span>
                </div>
            </div>
            <div class="flex flex-col gap-1 border-2 border-black px-2 pb-4">
                ...
                <div class="flex flex-col gap-2">
                    <span class="flex items-center gap-1">
                        <p>Địa chỉ: {{ package_detail.receiver_address }}</p>
                    </span>
                    <span class="flex items-center gap-1">
                        <p>
                            Số điện thoại: {{ package_detail.receiver_phone }}
                        </p>
                    </span>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-1 border-2 border-black px-2 pb-4">
                ...
                <div class="flex flex-col gap-2">
                    <span class="flex items-center gap-1">
                        <p>Khối lượng thực tế: {{ package_detail.weight }}kg</p>
                    </span>
                    <span class="flex items-center gap-1">
            ...
            <div class="flex flex-col gap-1 border-2 border-black px-2 pb-4">
                ...
                <div class="flex flex-col gap-2">
                    <p>
                        ...
                        hiểm, cấm gửi. Trường hợp không phát được hãy thực chỉ
                        dẫn tại mục 6, tôi sẽ trả cước chuyển hoàn.
                    </p>
                </div>
            </div>
            <div class="flex flex-col gap-1 border-2 border-black px-2 pb-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <span class="flex items-center gap-1">
                        <p class="font-semibold">
                            Người nhận/Người được ủy quyền nhận (Ký, ghi rõ họ
                            tên)
                        </p>
                    </span>
                </div>
            ...
            >
                Hotline: 1900 2811 2811 - Website: https://magicpost.vercel.app
